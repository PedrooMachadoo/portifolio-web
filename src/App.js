  ...
  return (
    <div className="App">
      ...
      <div className="curriculo">
        <p className='texto-curriculo'>Um designer apaixonado por esse universo inovador criativo que está em constante mudança. Aqui vai um pouco da minha trajetória como profissional e alguns dos meus trabalhos, espero que gostem e vamos mudar esse mundão juntos!!! </p>
